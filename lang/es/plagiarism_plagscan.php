...
$string['badcredentials'] = 'PlagScan no reconoce los detalles de la cuenta - por favor, confirme que la URL del servidor, nombre de usuario ({$a->user}), clave API y numero de versi&oacute;n ({$a->version}) son correctos';
