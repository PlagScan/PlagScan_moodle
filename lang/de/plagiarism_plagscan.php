...
$string['badcredentials'] = 'PlagScan hat die Zugangsdaten nicht erkannt, bitte prüfen Sie ob URL des Servers, Nutzername ({$a->user}), API Key und Versionsnummer ({$a->version}) korrekt sind';
...
$string['notprocessed'] = 'Plagscan hat Dokument noch nicht analysiert';
