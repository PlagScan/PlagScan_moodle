...
$string['badcredentials'] = 'PlagScan hat die Zugangsdaten nicht erkannt, bitte pr&uuml;fen Sie "Client ID" und "API Key" korrekt sind';
...
$string['error_submit'] = 'Problem beim Einreichen an PlagScan.';
...
$string['plagscan_ppp_policy'] = "Mit dem Plagiat-PrÃƒÂ¤ventions-Pool vergleichen";
...
$string['serverrejected'] = 'Der PlagScan Server hat diese Datei abgelehnt - sie ist besch&auml;digt, gesch&uuml;tzt oder enth&auml;lt wenige Zeichen (Mindestens 50 Zeichen verwenden).';
