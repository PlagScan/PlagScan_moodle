...
class user_search_completed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_user_search_completed', 'plagiarism_plagscan');
    }

    public function get_description() {
        $desc = 'The user ' . $this->userid . ' search in Plagscan completed';
